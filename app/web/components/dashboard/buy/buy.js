	...
	render() {
		...
		return (
			<Container style={styles.colorPrimary}>
				...
				>
					<Left>
						<Button transparent dark iconLeft onPress={() => navigate('Dashboard')}>
							<Icon name="md-arrow-back" style={styles.colorWhite} />
						</Button>
					</Left>
					<Body>
						<Title style={styles.title}>Buy</Title>
					</Body>
					<Right>
						<Title
				...
				<Tabs tabBarUnderlineStyle={styles.tabUnderline}>
					...
					>
						<Content>
							...
							>
								...
								>
									<View
										style={[styles.commonContainerStyles, {
											borderColor: colorWhite,
							...
							>
								<CardItem style={styles.carditem}>
									...
									<Body style={{ alignItems: 'flex-end' }}>
										<Text style={styles.colorWhite}>1.23456 BTC wallet</Text>
									</Body>
								</CardItem>
							</View>
							<View
							...
							<View style={styles.buyButtonContainer}>
								<Button large full style={styles.buyButton}>
									<Text style={styles.buyButtonText}>Buy Bitcoin</Text>
								</Button>
							</View>
						</Content>
					</Tab>
					...
					>
						<CardItem style={styles.carditem}>
							...
							<Body style={{ alignItems: 'flex-end' }}>
								<Text style={styles.colorWhite}>1.23456 ETH wallet</Text>
							</Body>
						</CardItem>
					</View>
					<View
					...
					<View style={styles.buyButtonContainer}>
						<Button large full style={styles.buyButton}>
							<Text style={styles.buyButtonText}>Buy Ethereum</Text>
						</Button>
					</View>
				</Content>
					</Tab>
